            ...
            <table class="table mb-0">
                ...
                <tr v-if="isUndefined(options.showHeader) || options.showHeader"
                    ...
                    <th v-if="!allColumnDisable && options.enableRowSelect"
                        ...
                        class="datatable-th  bg-green-1 border pr-0">
                    ...
                    <!--Column title-->
                    <th class="datatable-th bg-green-1 border"
                        ...
                        <span
                            ...
                            class="font-size-default color-white">
                            {{ column.title }}
                        </span>
                        <span
                            v-else
                ...
                <template v-if="dataSet.length > 0" v-for="(row, rowIndex) in dataSet">
                    <tr>
                        ...
                        <!--select row checkbox-->
                        <td v-if="!allColumnDisable && options.enableRowSelect" class="datatable-td pr-0 border">
                            <div class="customized-checkbox checkbox-default">
                                <input type="checkbox"
