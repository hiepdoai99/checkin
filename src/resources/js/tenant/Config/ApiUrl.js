...
//Camera
export const CAMERA_SETTINGS = `${TENANT_BASE_URL}app/settings/camera`;
export const CAMERA_HANETS = `${TENANT_BASE_URL}app/cameras/hanets`;
export const CAMERA_PLACES = `${TENANT_BASE_URL}app/cameras/places`;
export const CAMERA_DEVICES = `${TENANT_BASE_URL}app/cameras/devices`;
export const CAMERA_PERSONS = `${TENANT_BASE_URL}app/cameras/persons`;

// List employee
export const REPORT_EMPLOYEE = `${TENANT_BASE_URL}app/dashboard/report-employee`;

// Add Employee
export const ADD_EMPLOYEE = `${TENANT_BASE_URL}register`;
export const EVENTS = `${TENANT_BASE_URL}app/events`;
export const ASSIGN_TASK = `${TENANT_BASE_URL}app/assigned-task`;