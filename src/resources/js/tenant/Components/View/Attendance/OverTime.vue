<template>
    <div class="content-wrapper bg-white">
        <app-page-top-section :title="$t('overtime')">
            <app-over-time-top-buttons :tableId="id" :request-button="true"/>
...
<script>
import OverTimeMixin from "../../Mixins/OverTimeMixin";
import AttendanceRequestActionMixin from "../../Mixins/AttendanceRequestActionMixin";
import AppOverTimeTopButtons from "./Component/AppOverTimeTopButtons";
import AttendanceRequestContextMenu from "./Component/AttendanceRequest/AttendanceRequestContextMenu";

export default {
    mixins: [OverTimeMixin, AttendanceRequestActionMixin],
    components: { AppOverTimeTopButtons, AttendanceRequestContextMenu },
    props: {
        detailsId: {},
        attendanceId: {},
    },
