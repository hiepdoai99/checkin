<template>
    <div class="content-wrapper bg-white">
        <app-page-top-section :title="$t('meeting_room_management')">
            <app-default-button :title="$fieldTitle('add', 'meeting_room', true)" v-if="$can('create_working_shifts')"
            @click="openModal()" />
...
import RoomManagementMixin from "../../Mixins/RoomManagementMixin";
import { WORKING_SHIFTS } from "../../../Config/ApiUrl";

export default {
    name: "WorkingShift",
    mixins: [HelperMixin, RoomManagementMixin],
    data() {
        return {
            isModalActive: false,
            workingShiftId: '',
