...
return [
    ...
    'app' => [
        ...
        ['name' => 'language', 'value' => 'vi', 'context' => 'app', 'autoload' => 0, 'public' => 1],
        ['name' => 'date_format', 'value' => 'd-m-Y', 'context' => 'app', 'autoload' => 0, 'public' => 1],
        ['name' => 'time_format', 'value' => 'h', 'context' => 'app', 'autoload' => 0, 'public' => 1],
        ['name' => 'time_zone', 'value' => 'Asia/Ho_Chi_Minh', 'context' => 'app', 'autoload' => 0, 'public' => 1],
        ['name' => 'currency_symbol', 'value' => 'đ', 'context' => 'app', 'autoload' => 0, 'public' => 1],
        ...
        ['name' => 'currency_position', 'value' => 'suffix_with_space', 'context' => 'app', 'autoload' => 0, 'public' => 1],
    ],
    'brand' => [
