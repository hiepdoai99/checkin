<template>
    <div class="content-wrapper bg-white">
        <app-page-top-section :title="$t('late_leave_early')">
        ...
        <app-leave-late-early-create-edit-modal
...
<script>
import LeaveLateEarlyMixin from "../../Mixins/LeaveLateEarlyMixin";
import LeaveRequestActionMixin from "../../Mixins/LeaveRequestActionMixin";
import LeaveTopButtons from "./Components/LeaveTopButtonsLateEarly";
import LeaveRequestContextMenu from "./Components/LeaveRequestContextMenu";

export default {
    name: "LeaveRequest",
    mixins: [LeaveLateEarlyMixin, LeaveRequestActionMixin],
