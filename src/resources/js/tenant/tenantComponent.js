...
Vue.component('app-calender-adm', require('./Components/View/Dashboard/components/CalenderAdm').default)
Vue.component('app-calender-event', require('./Components/View/Dashboard/components/CalendarEvent.vue').default)
Vue.component('app-list-staff', require('./Components/View/Dashboard/components/ListStaffReport').default)
Vue.component('app-calender-modal', require('./Components/View/Dashboard/components/DashboardCreateEditCalenderModal').default)
Vue.component('app-list-late', require('./Components/View/Dashboard/components/ListLate').default)
Vue.component('app-list-early', require('./Components/View/Dashboard/components/ListEarly').default)
Vue.component('app-list-bussiness-travel', require('./Components/View/Dashboard/components/ListBusinessTravel').default)
Vue.component('app-list-leave', require('./Components/View/Dashboard/components/ListLeaver.vue').default)
...
Vue.component('app-tabs-departments', require('./Components/View/Employee/Department/TabsDepartments').default)
...
Vue.component('app-camera-settings-layout', require('./Components/View/Setting/CameraSettingLayout').default)
...
Vue.component('app-employee-add', require('./Components/View/Employee/EmployeeAddModal').default);
...
Vue.component('app-business-trip', require('./Components/View/Attendance/BusinessTrip').default);
Vue.component('app-business-trip-create-edit-modal', require('./Components/View/Attendance/Component/BusinessTripCreateEditModal').default);
Vue.component('app-over-time', require('./Components/View/Attendance/OverTime').default);
Vue.component('app-over-time-create-edit-modal', require('./Components/View/Attendance/Component/OverTimeCreateEditModal').default);
Vue.component('app-work-shift', require('./Components/View/Attendance/WorkShift').default);
Vue.component('app-work-shift-create-edit-modal', require('./Components/View/Attendance/Component/WorkShiftCreateEditModal').default);
...
Vue.component('app-leave-late-early-create-edit-modal', require('./Components/View/Leave/Components/LeaveLateEarlyCreateEditModal').default);
Vue.component('app-leave-response-log-modal', require('./Components/View/Leave/Components/ResponseLogModal.vue').default);
...
Vue.component('app-late-leave-early', require('./Components/View/Leave/LeaveLateEarly').default);
Vue.component('app-timekeeping-address', require('./Components/View/Leave/TimekeepingAddress').default);
...
Vue.component('app-setting-notification', require('./Components/View/Setting/SettingNotification').default);
Vue.component('app-day-off', require('./Components/View/Setting/DayOff').default);
...
//Camera
Vue.component('app-cameras', require('./Components/View/Camera/Cameras').default);
Vue.component('app-cameras-place', require('./Components/View/Camera/CamerasPlace').default);
Vue.component('app-cameras-person', require('./Components/View/Camera/CamerasPerson').default);
Vue.component('app-camera-api-setting', require('./Components/View/Camera/CameraApiSetting').default);
Vue.component('app-camera-api-create-edit', require('./Components/View/Camera/Components/CameraApiCreateEditModal').default);
Vue.component('app-camera-place-create-edit', require('./Components/View/Camera/Components/CameraPlaceCreateEditModal').default);
Vue.component('app-camera-person-create-edit', require('./Components/View/Camera/Components/CameraPersonCreateEditModal').default);
Vue.component('app-camera-person-sync', require('./Components/View/Camera/Components/CameraPersonSyncModal').default);

// Company Branch
Vue.component('app-company-branch', require('./Components/View/Adminstration/CompanyBranch/CompanyBranch').default);
Vue.component('app-company-branch-add', require('./Components/View/Adminstration/CompanyBranch/AddCompanyBranch').default);
Vue.component('app-company-branch-create-edit', require('./Components/View/Adminstration/CompanyBranch/CompanyBranchCreateEditModal').default);

// internal_communications
Vue.component('app-internal-newsletter', require('./Components/View/InternalCommunications/InternalNewsletter').default);
Vue.component('app-internal-events', require('./Components/View/InternalCommunications/InternalEvents').default);

// asset_management
Vue.component('app-meeting-room-management', require('./Components/View/AssetManagement/MeetingRoomManagement').default);
Vue.component('app-book-library-management', require('./Components/View/AssetManagement/BookLibraryManagement').default);

// other_utilities
Vue.component('app-calender', require('./Components/View/OtherUtilities/Calender').default);
Vue.component('app-numerology', require('./Components/View/OtherUtilities/Numerology').default);
// asign task
Vue.component('app-asign-task', require('./Components/View/AsignTask/AsignTask').default);
Vue.component('app-asign-task-edit-create-modal', require('./Components/View/AsignTask/Components/AsignTaskCreateEditModal').default);
Vue.component('app-asign-task-response-log-modal', require('./Components/View/AsignTask/Components/ResponseLogModal').default);