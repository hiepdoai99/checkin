...
Route::group(['prefix' => ''], function (Router $router) {
    ...
    $router->get('administration/company-branch', [NavigationController::class, 'companyBranch'])
        ->name('employee.companyBranch');
    ...
    $router->get('settings/setting-notification', [NavigationController::class, 'settingNotification'])
        ->name('settings.setting_notification');

    $router->get('settings/day-off', [NavigationController::class, 'dayOff'])
        ->name('settings.day_off');
    ...
    $router->get('settings/camera-settings', [NavigationController::class, 'cameraSettings'])
    ...
    $router->get('attendances/business-trip', [NavigationController::class, 'businessTrip'])
        ->name('attendances.business_trip');

    $router->get('attendances/work-shift', [NavigationController::class, 'workShift'])
        ->name('attendances.work_shift');

    $router->get('attendances/over-time', [NavigationController::class, 'overTime'])
        ->name('attendances.over_time');
    ...
    $router->get('leave/timekeeping-address', [NavigationController::class, 'timekeepingAddress'])
        ->name('leave.timekeeping_address');

    $router->get('leave/requests', [NavigationController::class, 'leaveRequests'])
        ->name('leave.requests')
        ->middleware('check_behavior');

    $router->get('leave/late-leave-early', [NavigationController::class, 'lateLeaveEarly'])
        ->name('leave.late_leave_early')
        ->middleware('check_behavior');
    ...
    $router->get('administration/places', [NavigationController::class, 'places'])
        ->name('places');

    $router->get('administration/cameras', [NavigationController::class, 'cameras'])
        ->name('cameras');

    $router->get('administration/persons', [NavigationController::class, 'persons'])
        ->name('persons');
    ...
    $router->get('internal-communications/internal-newsletter', [NavigationController::class, 'internalNewsletter'])
        ->name('internal_communications.internal_newsletter');

    $router->get('internal-communications/internal-events', [NavigationController::class, 'internalEvents'])
        ->name('internal_communications.internal_events');

    // asset_management
    $router->get('asset-management/meeting-room-management', [NavigationController::class, 'meetingRoomManagement'])
        ->name('asset_management.meeting_room_management');

    $router->get('asset-management/book-library-management', [NavigationController::class, 'bookLibraryManagement'])
        ->name('asset_management.book_library_management');

    // other_utilities
    $router->get('other-utilities/calender', [NavigationController::class, 'calender'])
        ->name('other_utilities.calender');

    $router->get('other-utilities/numerology', [NavigationController::class, 'numerology'])
        ->name('other_utilities.numerology');

    // asign task
    $router->get('asign-task', [NavigationController::class, 'asignTask'])
    ->name('asign_task.asign_task');
});
