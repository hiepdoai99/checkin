...
use App\Http\Controllers\Tenant\AssignedTask\AssignedTaskController;
...
use App\Http\Controllers\Tenant\Event\EventController;
...
Route::group(['prefix' => 'app'], function (Router $router) {
    ...
    $router->apiResource('assigned-task', AssignedTaskController::class);

    $router->apiResource('events', EventController::class);
...
Route::post(' register', [\App\Http\Controllers\Tenant\Auth\RegisteredUserController::class, 'register'])
